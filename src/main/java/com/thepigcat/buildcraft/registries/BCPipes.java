...
public final class BCPipes {
    ...
    // Wooden pipes - extracting (pull 4 items max), faster transport
    public static final PipeHolder WOODEN = HELPER.registerPipe("wooden", BCPipeTypes.EXTRACTING, "Wooden Pipe", 0.025f, List.of(
    ...
    // Cobblestone pipes - basic item transport (2 seconds per pipe)
    public static final PipeHolder COBBLESTONE = HELPER.registerPipe("cobblestone", BCPipeTypes.DEFAULT, "Cobblestone Pipe", 0.025f, List.of(
    ...
    // Gold pipes - fast item transport (1 second per pipe, 2x speed)
    public static final PipeHolder GOLD = HELPER.registerPipe("gold", BCPipeTypes.DEFAULT, "Gold Pipe", 0.05f, List.of(
    ...
    // Diamond pipes - extracting + filtering (pull 4 items max)
    public static final PipeHolder DIAMOND = HELPER.registerPipe("diamond", BCPipeTypes.DIAMOND, "Diamond Pipe", 0.033f, List.of(
    ...
    // Stone pipes - basic item transport (2 seconds per pipe)
    public static final PipeHolder STONE = HELPER.registerPipe("stone", BCPipeTypes.DEFAULT, "Stone Pipe", 0.025f, List.of(
    ...
    // Quartz pipes - basic item transport (2 seconds per pipe)
    public static final PipeHolder QUARTZ = HELPER.registerPipe("quartz", BCPipeTypes.DEFAULT, "Quartz Pipe", 0.025f, List.of(
    ...
    // Sandstone pipes - basic item transport (2 seconds per pipe)
    public static final PipeHolder SANDSTONE = HELPER.registerPipe("sandstone", BCPipeTypes.DEFAULT, "Sandstone Pipe", 0.025f, List.of(
    ...
    // Iron pipes - directional item transport (2 seconds per pipe)
    public static final PipeHolder IRON = HELPER.registerPipe("iron", BCPipeTypes.DEFAULT, "Iron Pipe", 0.025f, List.of(
    ...
    // Clay pipes - prioritize same-color containers (2 seconds per pipe)
    public static final PipeHolder CLAY = HELPER.registerPipe("clay", BCPipeTypes.DEFAULT, "Clay Pipe", 0.025f, List.of(
    ...
    // Emerald pipes - fast extracting (pull 64 items max), fast transport
    public static final PipeHolder EMERALD = HELPER.registerPipe("emerald", BCPipeTypes.EXTRACTING, "Emerald Pipe", 0.0625f, List.of(
